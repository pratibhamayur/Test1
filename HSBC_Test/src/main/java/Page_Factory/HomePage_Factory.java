...
public class HomePage_Factory extends TestBaseClass{

	public String API_Lates_Available(){
		driver.findElement(By.xpath("//div/ul[1]/li/a[text()='Latest']")).click();
		WebElement API= driver.findElement(By.xpath("//div[@id='latest']/p[2]"));
	...
	public String Get_Lates_API_Response(){
		String responce="";
		String APIlink= driver.findElement(By.xpath("//div[@id='latest']/p[2]")).getText();
